...
<body>
    <nav class="navbar navbar-dark"><a href="/login">Volver</a></nav>
    ...
    <div class="card" style="width: 18rem;">
        ...
        <div class="d-grid mt-3">
            <a href="/test/java" class="btn btn-dark boton">Java</a>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            <div class="d-grid mt-3">
                <a href="/test/javascript" class="btn btn-dark boton">JavaScript</a>
            </div>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        ...
        <div class="d-grid mt-3">
            <a href="/test/python" class="btn btn-dark boton">Python</a>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        ...
        <div class="d-grid mt-3">
            <a href="/test/c++" class="btn btn-dark boton">C++</a>
        </div>
    </div>
</body>
</html>